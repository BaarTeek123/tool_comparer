...
from Comparer import correct_spelling_autocorrect, correct_spelling_spell_checker, correct_spelling_txt_blb, \
    grammar_check_gingerit, grammar_check_language_tool, TestedSentence
...
def verify_sentences(foo, template: str, test_sentence: str, path_to_file: str):
    ...
    dictionary = TestedSentence(str(template), str(foo(str(test_sentence)))).__dict__
...
directory = 'sentences'  # directory with .txt files :
